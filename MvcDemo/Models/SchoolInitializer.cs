...
namespace MvcDemo.Models
{
    public class SchoolInitializer: DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            {
                new Student {FirstName = "James", LastName = "Dean", EnrollmentDate = DateTime.Parse("2016-01-03")},
                new Student {FirstName = "Lynda", LastName = "Thames", EnrollmentDate = DateTime.Parse("2016-01-24")}
            };
